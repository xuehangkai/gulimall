...
CREATE TABLE `ums_growth_change_history` (
  ...
  `note` varchar(0) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '备注',
  `source_type` tinyint(4) DEFAULT NULL COMMENT '积分来源[0-购物，1-管理员修改]',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='成长值变化历史记录';
...
CREATE TABLE `ums_integration_change_history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='积分变化历史记录';
...
CREATE TABLE `ums_member` (
  ...
  `header` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '头像',
  ...
  `social_uid` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `ums_member_collect_spu` (
  ...
  `spu_name` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'spu_name',
  `spu_img` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'spu_img',
  `create_time` datetime DEFAULT NULL COMMENT 'create_time',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='会员收藏的商品';
...
CREATE TABLE `ums_member_collect_subject` (
  ...
  `subject_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'subject_name',
  `subject_img` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'subject_img',
  `subject_urll` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '活动url',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='会员收藏的专题活动';
...
CREATE TABLE `ums_member_level` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `name` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '等级名称',
  ...
  `note` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='会员等级';
...
CREATE TABLE `ums_member_login_log` (
  ...
  `city` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'city',
  `login_type` tinyint(1) DEFAULT NULL COMMENT '登录类型[1-web，2-app]',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='会员登录记录';
...
CREATE TABLE `ums_member_receive_address` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `member_id` bigint(20) DEFAULT NULL COMMENT 'member_id',
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '收货人姓名',
  `phone` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '电话',
  `post_code` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '邮政编码',
  `province` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '省份/直辖市',
  `city` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '城市',
  `region` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '区',
  `detail_address` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '详细地址(街道)',
  `areacode` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '省市区代码',
  `default_status` tinyint(1) DEFAULT NULL COMMENT '是否默认',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='会员收货地址';
...
CREATE TABLE `ums_member_statistics_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='会员统计信息';
